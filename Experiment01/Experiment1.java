...
class Experiment1 {
    ...
    public static void sumAverageRunningIntModified(int lowerbound, int upperbound) {
        double averageOdd = 0, averageEven = 0;
        ...
        averageEven /= (double) (upperbound - lowerbound);
        averageOdd /= (double) (upperbound - lowerbound);
        System.out.println("average of even no's : " + averageEven);
        System.out.println("average of odd no's : " + averageOdd);
    }
